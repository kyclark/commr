...
// --------------------------------------------------
#[test]
fn file1_file2_1_3() -> Result<()> {
    run(&["-13", FILE1, FILE2], "tests/expected/file1_file2.13.out")
}

// --------------------------------------------------
#[test]
fn file1_file2_1_2_3() -> Result<()> {
    run(
        &["-123", FILE1, FILE2],
...
// --------------------------------------------------
#[test]
fn file1_blank() -> Result<()> {
    run(&[FILE1, BLANK], "tests/expected/file1_blank.out")
}

// --------------------------------------------------
#[test]
fn file1_blank_1() -> Result<()> {
    run(&[FILE1, BLANK, "-1"], "tests/expected/file1_blank.1.out")
}

// --------------------------------------------------
#[test]
fn file1_blank_2() -> Result<()> {
    run(&[FILE1, BLANK, "-2"], "tests/expected/file1_blank.2.out")
}

// --------------------------------------------------
#[test]
fn file1_blank_3() -> Result<()> {
    run(&[FILE1, BLANK, "-3"], "tests/expected/file1_blank.3.out")
}
